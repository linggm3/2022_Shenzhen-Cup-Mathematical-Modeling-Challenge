...
for time = 1:times % 双层规划次数
    ...
    if time == 1
        [best_individual, fit, run_time1, counter] = Genetic_algorithm_tmp(epoch, pop_size, individual_size, pm, supply, center, center_load, 123);
    end
...
%     [dot, fit, run_time1] = Genetic_algorithm(1000, pop_size, individual_size, pm, supply, center, center_load);
    ...
    [dot, cost, run_time2, counter] = Simulated_annealing_tmp2(temterature, innerloop, dc, dot, supply, center, center_load, spacing, boxx, boxy, counter, 123);
